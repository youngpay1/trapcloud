...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <nav className="flex items-center justify-between h-[68px] md:h-20 px-5 md:px-8">
        ...
        <Link to="/" className="hidden md:flex items-center">
          ...
          />
          <span
            className="font-display text-sm tracking-[0.25em] uppercase hidden"
            style={{ display: 'none' }}
          >
            TRAPCLOUD
          </span>
              ...
              <Link
                ...
                className={`font-display text-lg tracking-wide transition-all duration-300 ${
                  location.pathname === link.path
                    ? 'text-foreground [text-shadow:0_0_2px_hsl(217_91%_70%),0_0_5px_hsl(217_91%_65%),0_0_10px_hsl(217_91%_60%),0_0_20px_hsl(217_91%_60%),0_0_40px_hsl(217_91%_60%/0.8),0_0_60px_hsl(217_91%_60%/0.6),0_0_80px_hsl(217_91%_60%/0.4)]'
                    : 'text-foreground/60'
                }`}
              >
                {link.label}
